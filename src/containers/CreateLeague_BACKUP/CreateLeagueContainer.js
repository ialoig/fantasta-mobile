...
export class CreateLeagueContainer extends React.Component {
	...
	componentDidUpdate(){
		console.log(`9999999999999 componentDidUpdate`)
		console.log(`9999999999999 this.state.settings}: ${JSON.stringify(this.state.settings, null, 2)}`)
	}
	...
	async onDone() {
		const validation_result = this.validatePage(pages.length - 1)
		console.log(`0000000000000 validation_result="${validation_result}"`)
		if (validation_result) {
			// try {
				console.log(`calling Leagues.Create`)
				console.log(`0000000000000 this.state.settings}: ${JSON.stringify(this.state.settings, null, 2)}`)
				console.log(`====================`)
